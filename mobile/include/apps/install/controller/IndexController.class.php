...
class IndexController extends Controller {
    ...
    public function importing() {
        ...
        if (!model('Install')->get_column($configDb, $dbPrefix . 'pay_log', 'openid')) {
            $sqlData[] = "ALTER TABLE `".$dbPrefix."pay_log` ADD COLUMN `openid` VARCHAR( 255 ) NOT NULL AFTER  `is_paid`, ADD COLUMN `transid` VARCHAR( 255 ) NOT NULL AFTER  `openid`;";
        }
