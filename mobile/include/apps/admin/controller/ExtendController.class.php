    ...
    public function index()
    {
        ...
        if (! empty($modules)) {
            foreach ($modules as $k => $v) {
                ...
                if($this->wechat_type == 0){
                    if($modules[$k]['command'] == 'bd'  || $modules[$k]['command'] == 'bonus' || $modules[$k]['command'] == 'ddcx' || $modules[$k]['command'] == 'jfcx' || $modules[$k]['command'] == 'sign' || $modules[$k]['command'] == 'wlcx'  || $modules[$k]['command'] == 'zjd'){
                        unset($modules[$k]);
                    }
                }elseif($this->wechat_type == 1){
                    if($modules[$k]['command'] == 'bd' || $modules[$k]['command'] == 'bonus' || $modules[$k]['command'] == 'zjd' ){
                        unset($modules[$k]);
                    }
                }
