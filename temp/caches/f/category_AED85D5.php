...
<title>个人护理_聚美优品模板 聚美优品商城2014洁版模板 ECSHOP模板堂（www.ecmoban.com）专业ECSHOP模板制作 ECSHOP模板定制_ECSHOP模板修改_ECSHOP模板出售_ECSHOP模板案例 - Powered by ECShop</title>
...
<div class="blank"></div>
 <div id="ur_here">
当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=21">个人护理</a> 
</div>
</div>
<div class="blank"></div>
...
document.getElementById('history_list').innerHTML = '您已清空最近浏览过的商品';
  ...
  <div class="AreaR">
		 ...
		 <div class="box_1">
			...
			<strong>价格 :</strong>
											<span>全部</span>
															<a href="category.php?id=21&amp;price_min=20&amp;price_max=50">20&nbsp;-&nbsp;50</a>&nbsp;
															<a href="category.php?id=21&amp;price_min=50&amp;price_max=80">50&nbsp;-&nbsp;80</a>&nbsp;
															<a href="category.php?id=21&amp;price_min=80&amp;price_max=110">80&nbsp;-&nbsp;110</a>&nbsp;
															<a href="category.php?id=21&amp;price_min=140&amp;price_max=170">140&nbsp;-&nbsp;170</a>&nbsp;
															<a href="category.php?id=21&amp;price_min=290&amp;price_max=320">290&nbsp;-&nbsp;320</a>&nbsp;
										</div>
						      <div class="screeBox">
			<strong>袖型 :</strong>
											<span>全部</span>
...
<div class="box">
 <div class="box_1">
  ...
  <a href="javascript:;" onClick="javascript:display_mode('grid')"><img src="themes/ecmoban_jumei/images/display_mode_grid.gif" alt=""></a>
  <a href="javascript:;" onClick="javascript:display_mode('text')"><img src="themes/ecmoban_jumei/images/display_mode_text_act.gif" alt=""></a>&nbsp;&nbsp;
  
  <a href="category.php?category=21&display=text&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img src="themes/ecmoban_jumei/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=21&display=text&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/ecmoban_jumei/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=21&display=text&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/ecmoban_jumei/images/last_update_default.gif" alt="按更新时间排序"></a>
  ...
  <input type="hidden" name="order" value="DESC" />
    ...
    <a href="javascript:;" id="compareLink" onClick="Compare.add(141,'兰蔻清滢柔肤水400ml','14')"
 class="f6">比较</a>
    </li>
    <li class="goodsName">
    <div class="div_name">
    ...
    <li class="action">
         市场价格：<font class="market">420元</font><br />
            促销价：<font class="shop">110元</font><br />
        </li>
    </ul>
         <ul class="clearfix bgcolor"id="bgcolor">
    <li style="margin-right:15px;">
    <a href="javascript:;" id="compareLink" onClick="Compare.add(140,'完美芦荟胶一对 40g*2','14')"
 class="f6">比较</a>
    </li>
    <li class="goodsName">
    <div class="div_name">
    ...
    <li class="action">
         市场价格：<font class="market">76元</font><br />
            促销价：<font class="shop">110元</font><br />
        </li>
    </ul>
         <ul class="clearfix bgcolor"id="bgcolor">
    <li style="margin-right:15px;">
    <a href="javascript:;" id="compareLink" onClick="Compare.add(139,'珀莱雅(PROYA)新柔皙美白补水套装(洗颜霜120ml+玫瑰水120ml+保湿乳100ml)','14')"
 class="f6">比较</a>
    </li>
    <li class="goodsName">
    <div class="div_name">
    <a href="goods.php?id=139" class="f6 f5">
                珀莱雅(PROYA)新柔皙美白补水套装(洗颜霜120ml+玫瑰水120ml+保湿乳100ml)<br />
              </a>
    ...
    <li class="action">
         市场价格：<font class="market">193元</font><br />
            促销价：<font class="shop">110元</font><br />
        </li>
    </ul>
         <ul class="clearfix bgcolor"id="bgcolor">
    <li style="margin-right:15px;">
    <a href="javascript:;" id="compareLink" onClick="Compare.add(138,'私密沐浴露+秘隐曼妙湿巾','14')"
 class="f6">比较</a>
    </li>
    <li class="goodsName">
    <div class="div_name">
    ...
    <li class="action">
         市场价格：<font class="market">60元</font><br />
            本店售价：<font class="shop">50元</font><br />
        </li>
    </ul>
         <ul class="clearfix bgcolor"id="bgcolor">
    <li style="margin-right:15px;">
    <a href="javascript:;" id="compareLink" onClick="Compare.add(137,'海绵宝宝多元海藻呵护洗沐500ml','14')"
 class="f6">比较</a>
    </li>
    <li class="goodsName">
    <div class="div_name">
    <a href="goods.php?id=137" class="f6 f5">
                海绵宝宝多元海藻呵护洗沐500ml<br />
              </a>
    ...
    <li class="action">
         市场价格：<font class="market">200元</font><br />
            本店售价：<font class="shop">87元</font><br />
        </li>
    </ul>
         <ul class="clearfix bgcolor"id="bgcolor">
    <li style="margin-right:15px;">
    <a href="javascript:;" id="compareLink" onClick="Compare.add(136,'佳洁士全优7效牙膏+漱口水装','14')"
 class="f6">比较</a>
    </li>
    <li class="goodsName">
    <div class="div_name">
    ...
    <li class="action">
         市场价格：<font class="market">26元</font><br />
            促销价：<font class="shop">110元</font><br />
        </li>
    </ul>
         <ul class="clearfix bgcolor"id="bgcolor">
    <li style="margin-right:15px;">
    <a href="javascript:;" id="compareLink" onClick="Compare.add(134,'飘柔（Rejoice）倍瑞丝护理专研顺滑优惠装（洗发露450ML+护发素230ML）','14')"
 class="f6">比较</a>
    </li>
    <li class="goodsName">
    <div class="div_name">
    <a href="goods.php?id=134" class="f6 f5">
                飘柔（Rejoice）倍瑞丝护理专研顺滑优惠装（洗发露450ML+护发素230ML）<br />
              </a>
    ...
    <li class="action">
         市场价格：<font class="market">50元</font><br />
            促销价：<font class="shop">110元</font><br />
        </li>
    </ul>
        </div>
