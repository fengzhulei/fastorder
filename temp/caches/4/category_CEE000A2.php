...
<title>服饰内衣_聚美优品模板 聚美优品商城2014洁版模板 ECSHOP模板堂（www.ecmoban.com）专业ECSHOP模板制作 ECSHOP模板定制_ECSHOP模板修改_ECSHOP模板出售_ECSHOP模板案例 - Powered by ECShop</title>
...
<div class="menu">
  <a href="index.php">首页</a>
   ...
   <a href="category.php?id=69"   class="cur">服饰内衣</a>
...
<div class="blank"></div>
 <div id="ur_here">
当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=69">服饰内衣</a> 
</div>
</div>
<div class="blank"></div>
...
<div class="box">
 <div class="box_1">
  ...
  <a href="category.php?category=69&display=text&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list"><img src="themes/ecmoban_jumei/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=69&display=text&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/ecmoban_jumei/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=69&display=text&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/ecmoban_jumei/images/last_update_default.gif" alt="按更新时间排序"></a>
